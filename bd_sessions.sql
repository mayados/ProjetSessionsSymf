...
-- Listage des données de la table projetsessionsm.categorie : ~5 rows (environ)
...
-- Listage des données de la table projetsessionsm.session : ~5 rows (environ)
...
-- Listage de la structure de la table projetsessionsm. user
...
-- Listage des données de la table projetsessionsm.user : ~0 rows (environ)
