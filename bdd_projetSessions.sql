...
-- Listage des données de la table projetsessionsm.doctrine_migration_versions : ~1 rows (environ)
...
-- Listage des données de la table projetsessionsm.formation : ~3 rows (environ)
...
-- Listage des données de la table projetsessionsm.module : ~13 rows (environ)
...
-- Listage des données de la table projetsessionsm.programme : ~13 rows (environ)
...
-- Listage des données de la table projetsessionsm.session_stagiaire : ~6 rows (environ)
...
-- Listage des données de la table projetsessionsm.stagiaire : ~5 rows (environ)
...
INSERT INTO `stagiaire` (`id`, `nom`, `prenom`, `sexe`, `date_naissance`, `ville`, `mail`, `telephone`) VALUES
	(1, 'Dos', 'Marianne', 'homme', '2000-01-20', 'Strasbourg', 'marianne@gmail.com', '0611223344'),
	(2, 'Da Silva', 'Manuel', 'Homme', '1998-04-05', 'Strasbourg', 'manuel@gmail.com', '0622334455'),
	(3, 'Dubois', 'Julie', 'Femme', '1999-08-28', 'Obernai', 'julie@gmail.com', '0633445566'),
	(8, 'Hoquet', 'Guy', 'homme', '1995-09-07', 'Molsheim', 'guy@gmail.com', '0655889977'),
	(9, 'Sur', 'Eric', 'homme', '1994-05-28', 'Mulhouse', 'eric@gmail.com', '0699887711');
